    ...
    <article className={className}>
      <header className="mb-4">
        <div className="relative mb-8">
          ...
          />
          <span className="absolute -bottom-6 right-[9%] block w-16 rounded bg-primary px-4 py-3 text-center text-sm font-medium leading-tight text-white shadow-md sm:w-17 sm:text-base sm:leading-tight">
